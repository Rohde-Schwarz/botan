...
typedef enum /* NOLINT(*-enum-size) */ {
   BOTAN_X509_SERIAL_NUMBER,            /** singleton binary big-endian encoding */
   BOTAN_X509_SUBJECT_DN_BITS,          /** singleton binary DER encoding of the subject distinguished name */
   BOTAN_X509_ISSUER_DN_BITS,           /** singleton binary DER encoding of the issuer distinguished name */
   BOTAN_X509_SUBJECT_KEY_IDENTIFIER,   /** singleton binary encoding */
   BOTAN_X509_AUTHORITY_KEY_IDENTIFIER, /** singleton binary encoding */
   BOTAN_X509_PUBLIC_KEY_PKCS8_BITS,    /** singleton binary DER encoding of the PKCS#8 public key */
   BOTAN_X509_TBS_DATA_BITS,            /** singleton binary DER encoding */
   BOTAN_X509_SIGNATURE_SCHEME_BITS,    /** singleton binary DER encoding of the algorithm identifier */
   BOTAN_X509_SIGNATURE_BITS,           /** singleton binary signature bits */
   BOTAN_X509_DER_ENCODING,             /** singleton binary DER encoding of the whole object */
   BOTAN_X509_CRL_DISTRIBUTION_URLS,    /** multi-value string of the CRL distribution points */
   BOTAN_X509_OCSP_RESPONDER_URLS,      /** multi-value string of the OCSP responder URLs */
   BOTAN_X509_CA_ISSUERS_URLS,          /** multi-value string of the CA issuer URLs */
