...
Server_Hello_12::Server_Hello_12(Handshake_IO& io,
      ...
      Server_Hello_12(std::make_unique<Server_Hello_Internal>(
         ...
         make_server_hello_random(rng, server_settings.protocol_version(), cb, policy, is_datagram),
...
Server_Hello_12::Server_Hello_12(Handshake_IO& io,
      ...
      Server_Hello_12(std::make_unique<Server_Hello_Internal>(
         ...
         make_server_hello_random(rng, resumed_session.version(), cb, policy, is_datagram),
