 ...
 */
static TSS2_RC hash_start(ESYS_CRYPTO_CONTEXT_BLOB** context, TPM2_ALG_ID hash_alg, void* userdata) {
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC hash_update(ESYS_CRYPTO_CONTEXT_BLOB* context, const uint8_t* buffer, size_t size, void* userdata) {
   BOTAN_UNUSED(userdata);
   return thunk([&] {
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC hash_finish(ESYS_CRYPTO_CONTEXT_BLOB** context, uint8_t* buffer, size_t* size, void* userdata) {
   BOTAN_UNUSED(userdata);
   return thunk([&] {
 ...
 * @param[in,out] userdata information.
 */
static void hash_abort(ESYS_CRYPTO_CONTEXT_BLOB** context, void* userdata) {
   BOTAN_UNUSED(userdata);
   delete *context;
   *context = nullptr;
}
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC hmac_update(ESYS_CRYPTO_CONTEXT_BLOB* context, const uint8_t* buffer, size_t size, void* userdata) {
   BOTAN_UNUSED(userdata);
   return thunk([&] {
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC hmac_finish(ESYS_CRYPTO_CONTEXT_BLOB** context, uint8_t* buffer, size_t* size, void* userdata) {
   BOTAN_UNUSED(userdata);
   return thunk([&] {
      auto hmac = get<Botan::MessageAuthenticationCode>(*context);
      if(!hmac) {
 ...
 * @param[in,out] userdata information.
 */
static void hmac_abort(ESYS_CRYPTO_CONTEXT_BLOB** context, void* userdata) {
   BOTAN_UNUSED(userdata);
   delete *context;
   *context = nullptr;
}
 ...
 */
static TSS2_RC get_random2b(TPM2B_NONCE* nonce, size_t num_bytes, void* userdata) {
   return thunk([&] {
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC rsa_pk_encrypt(TPM2B_PUBLIC* pub_tpm_key,
                              size_t in_size,
                              BYTE* in_buffer,
                              size_t max_out_size,
                              BYTE* out_buffer,
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC get_ecdh_point(TPM2B_PUBLIC* key,
                              size_t max_out_size,
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC aes_encrypt(uint8_t* key,
                           TPM2_ALG_ID tpm_sym_alg,
                           TPMI_AES_KEY_BITS key_bits,
                           TPM2_ALG_ID tpm_mode,
                           uint8_t* buffer,
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC aes_decrypt(uint8_t* key,
                           TPM2_ALG_ID tpm_sym_alg,
                           TPMI_AES_KEY_BITS key_bits,
                           TPM2_ALG_ID tpm_mode,
                           uint8_t* buffer,
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC sm4_encrypt(uint8_t* key,
                           TPM2_ALG_ID tpm_sym_alg,
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC sm4_decrypt(uint8_t* key,
                           TPM2_ALG_ID tpm_sym_alg,
                           TPMI_SM4_KEY_BITS key_bits,
                           TPM2_ALG_ID tpm_mode,
                           uint8_t* buffer,
 ...
 * @retval USER_DEFINED user defined errors on failure.
 */
static TSS2_RC init(void* userdata) {
