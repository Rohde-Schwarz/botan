...
#ifndef BOTAN_OUNSWORTH_MODE_H
#define BOTAN_OUNSWORTH_MODE_H
...
class BOTAN_UNSTABLE_API Mode {
   public:
      ...
      std::variant<std::unique_ptr<HashFunction>, std::unique_ptr<MAC>> kdf_instance(size_t output_bytes) const;
