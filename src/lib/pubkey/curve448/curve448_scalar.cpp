 ...
 */
std::array<word, WORDS_446> add(std::span<const word, WORDS_446> x, std::span<const word, WORDS_446> y) {
   std::array<word, WORDS_446> res;
   copy_mem(res, x);
 ...
 */
std::array<word, WORDS_446> ct_reduce_mod_L(const std::array<word, WORDS_REDUCE_SZ> x) {
