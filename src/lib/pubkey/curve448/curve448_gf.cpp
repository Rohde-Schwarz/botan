/*
* Curve448 Gf Modulo 2^448 - 2^224 - 1
* (C) 2024 Jack Lloyd
...
Gf448Elem Gf448Elem::square() const {
   Gf448Elem res(0);
   gf_square(res.m_x, m_x);
   return res;
}
