      ...
      void go() override {
         ...
         */
         ...
         for(const auto& algo : algos) {
            ...
            else if(algo == "Curve448") {
               bench_curve448(provider, msec);
            }
#endif
#if defined(BOTAN_HAS_MCELIECE)
...
#if defined(BOTAN_HAS_CURVE_448)
      void bench_curve448(const std::string& provider, std::chrono::milliseconds msec) {
         bench_pk_ka("Curve448", "Curve448", "", provider, msec);
      }
#endif
