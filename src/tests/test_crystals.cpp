...
Test::Result test_extended_euclidean_algorithm() {
   ...
   res.test_is_eq<uint16_t>("q^-1(3329) - Kyber::Q", Botan::modular_inverse<uint16_t>(3329), 62209);
   res.test_is_eq<uint32_t>("q^-1(8380417) - Dilithium::Q", Botan::modular_inverse<uint32_t>(8380417), 58728449);
...
BOTAN_REGISTER_TEST_FN("pubkey", "CRYSTALS", test_extended_euclidean_algorithm, test_polynomials);
