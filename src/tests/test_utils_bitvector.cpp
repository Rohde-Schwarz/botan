...
std::vector<Test::Result> test_bitvector_constant_time_operations() {
   return {
      Botan_Tests::CHECK("conditional XOR, block aligned",
                         [](auto& result) {
                            Botan::bitvector bv1(Botan::hex_decode("BAADF00D"));
                            Botan::secure_bitvector bv2(Botan::hex_decode("CAFEBEEF"));
      ...
      Botan_Tests::CHECK("conditional XOR, byte aligned",
                         [](auto& result) {
                            Botan::bitvector bv1(Botan::hex_decode("BAADF00D42"));
                            Botan::secure_bitvector bv2(Botan::hex_decode("CAFEBEEF13"));
                            const auto initial_bv1 = bv1;
                            const auto xor_result = bv1 ^ bv2;
