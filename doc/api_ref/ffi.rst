...
.. cpp:function:: int botan_x509_cert_view_binary_values(botan_x509_cert_t cert, \
   ...
   Some of those may multi-value fields, the `index` parameter may be used to
   enumerate those values until :cpp:enumerator:`BOTAN_FFI_ERROR_OUT_OF_RANGE`
...
.. cpp:enumerator:: BOTAN_X509_PUBLIC_KEY_PKCS8_BITS
   ...
   The certificate's public key in PKCS#8 format using (DER encoding).
...
.. cpp:enumerator:: BOTAN_X509_DER_ENCODING
   ...
   The DER encoding of the entire certificate or CRL object.
